...
/// @notice ERC4626 compliant vault allowing users to deposit assets to any ERC4626 vault allowed by the factory.
contract EulerEarn is ReentrancyGuard, ERC4626, Ownable2Step, EVCUtil, IEulerEarnStaticTyping {
    ...
    /// @inheritdoc IERC4626
    /// @dev totalAssets is the sum of the vault's assets on the allowed vaults plus the lost assets (see corresponding
    ...
    /// @dev Returns the maximum amount of assets that the Earn vault can supply to the allowed vaults.
    ...
    /// @inheritdoc ERC4626
    /// @dev Used in mint or deposit to deposit the underlying asset to allowed vaults.
    ...
    /// @inheritdoc ERC4626
    /// @dev Used in redeem or withdraw to withdraw the underlying asset from the allowed vaults.
    ...
    /// @dev Supplies `assets` to the allowed vaults.
    ...
    /// @dev Withdraws `assets` from the allowed vaults.
    ...
    /// @dev Simulates a withdraw of `assets` from the allowed vaults.
    ...
    {
        // The assets that the Earn vault has on the allowed vaults.
