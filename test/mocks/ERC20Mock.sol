 ...
 *     approve/require-non-zero-allowance                                      Require the allowance to be > 0
...
contract ERC20Mock {
    ...
    function approve(address spender, uint256 amount) external {
        ...
        (isSet,) = behaviour("approve/require-non-zero-allowance");
        if (isSet && amount == 0) revert("revert require-non-zero-allowance");
    ...
    function transfer(address recipient, uint256 amount) public virtual {
        ...
        console.log('getAccount(): ', getAccount(), balanceOf(getAccount()));
    ...
    function burn(address account, uint256 amount) external secured {
