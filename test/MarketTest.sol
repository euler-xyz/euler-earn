...
//     function testSubmitCapInconsistentAsset(IERC4626 id) public {
...
//     function testSubmitCapMarketNotCreated(IERC4626 id) public {
...
//         assertEq(IERC4626.unwrap(vault.supplyQueue(0)), IERC4626.unwrap(allMarkets[1].id()));
//         assertEq(IERC4626.unwrap(vault.supplyQueue(1)), IERC4626.unwrap(allMarkets[2].id()));
//     }
...
//         IERC4626 id = allMarkets[ConstantsLib.MAX_QUEUE_LENGTH];
...
//         assertEq(IERC4626.unwrap(vault.withdrawQueue(0)), IERC4626.unwrap(expectedWithdrawQueue[0]));
//         assertEq(IERC4626.unwrap(vault.withdrawQueue(1)), IERC4626.unwrap(expectedWithdrawQueue[1]));
//         assertEq(IERC4626.unwrap(vault.withdrawQueue(2)), IERC4626.unwrap(expectedWithdrawQueue[2]));
//         assertEq(IERC4626.unwrap(vault.withdrawQueue(3)), IERC4626.unwrap(expectedWithdrawQueue[3]));
//     }
...
//         vault.revokePendingCap(IERC4626.wrap(bytes32(0)));
//         vault.revokePendingMarketRemoval(IERC4626.wrap(bytes32(0)));
//         vm.stopPrank();
//     }
// }
