...
// import {EulerEarnMock} from "../src/mocks/EulerEarnMock.sol";
...
//         eulerEarnMock =
//             new EulerEarnMock(OWNER, address(morpho), 1 days, address(loanToken), "EulerEarn Vault", "MM");
...
//             eulerEarnMock.mockSetCap(allMarkets[i], allMarkets[i].id(), CAP);
//         }

//         vm.expectRevert(ErrorsLib.MaxQueueLengthExceeded.selector);
//         eulerEarnMock.mockSetCap(allMarkets[NB_MARKETS - 1], allMarkets[NB_MARKETS - 1].id(), CAP);
//     }
...
//         eulerEarnMock.mockSetCap(allMarkets[0], allMarkets[0].id(), CAP);
