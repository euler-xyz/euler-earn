...
contract WithdrawGasMetering is YieldAggregatorBase {
    ...
    function testWithdrawFromStrategies_SingleStrategyNoHarvest() public {
    ...
    /// this before removing cooldown period
    // before running this, undo the changes in src/module/YieldAggregatorVault.sol
    function testWithdrawFromStrategies_FiveStrategiesNoHarvest() public {
    ...
    // this should withdraw from cash reserve only
    /// this before removing cooldown period
    // before running this, undo the changes in src/module/YieldAggregatorVault.sol
    function testWithdrawFromCashReserve_FiveStrategiesNoHarvest() public {
        IEVault eTSTsecondary;
        IEVault eTSTthird;
        IEVault eTSTforth;
        IEVault eTSTfifth;
        ...
        eulerYieldAggregatorVault.harvest();
        {
            uint256 amountToWithdraw = assetTST.balanceOf(address(eulerYieldAggregatorVault)) - 1;
    ...
    // this should withdraw from cash reserve and two other startegies only
    /// this before removing cooldown period
    // before running this, undo the changes in src/module/YieldAggregatorVault.sol
    function testWithdrawFromCashReservePlusTwoStrategies_FiveStrategiesNoHarvest() public {
        IEVault eTSTsecondary;
        IEVault eTSTthird;
        IEVault eTSTforth;
        IEVault eTSTfifth;
        ...
        {
            uint256 allocatedInFirstStrat = eulerYieldAggregatorVault.getStrategy(address(eTST)).allocated;
            uint256 allocatedInSecondStrat = eulerYieldAggregatorVault.getStrategy(address(eTSTsecondary)).allocated;

            uint256 amountToWithdraw = assetTST.balanceOf(address(eulerYieldAggregatorVault)) - 1
                + allocatedInFirstStrat + allocatedInSecondStrat;
    ...
    function testWithdrawFromStrategies_SingleStrategyNoYieldNoLoss() public {
        uint256 amountToDeposit = 10000e18;
    ...
    function testWithdrawFromStrategies_TwoStrategiesNoYieldNoLoss() public {
        IEVault eTSTsecondary;
        {
            eTSTsecondary = IEVault(
                factory.createProxy(
    ...
    function testWithdrawFromStrategies_ThreeStrategiesNoYieldNoLoss() public {
        IEVault eTSTsecondary;
        IEVault eTSTthird;
        {
            eTSTsecondary = IEVault(
    ...
    function testWithdrawFromStrategies_FiveStrategiesNoYieldNoLoss() public {
        IEVault eTSTsecondary;
        IEVault eTSTthird;
        IEVault eTSTforth;
        IEVault eTSTfifth;
    ...
    function testWithdrawFromStrategies_SingleStrategyWithYield() public {
        uint256 amountToDeposit = 10000e18;
    ...
    function testWithdrawFromStrategies_TwoStrategiesWithYield() public {
        IEVault eTSTsecondary;
        {
            eTSTsecondary = IEVault(
                factory.createProxy(
    ...
    function testWithdrawFromStrategies_FiveStrategiesWithYield() public {
        IEVault eTSTsecondary;
        IEVault eTSTthird;
        IEVault eTSTforth;
        IEVault eTSTfifth;
    ...
    function testWithdrawFromStrategies_SingleStrategyWithLoss() public {
        uint256 amountToDeposit = 10000e18;
    ...
    function testWithdrawFromStrategies_FiveStrategiesWithLoss() public {
        IEVault eTSTsecondary;
        IEVault eTSTthird;
        IEVault eTSTforth;
        IEVault eTSTfifth;
    ...
    // this should withdraw from cash reserve only
    function testWithdrawFromCashReserve_FiveStrategiesWithYield() public {
        IEVault eTSTsecondary;
        IEVault eTSTthird;
        IEVault eTSTforth;
        IEVault eTSTfifth;
    ...
    // this should withdraw from cash reserve and two strategies
    function testWithdrawFromCashReservePlusTwoStrategies_FiveStrategiesWithYield() public {
        IEVault eTSTsecondary;
        IEVault eTSTthird;
        IEVault eTSTforth;
        IEVault eTSTfifth;
